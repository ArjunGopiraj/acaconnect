...
if real_data:
    print(f"\n[OK] Real data loaded successfully!")
    ...
    print(f"\n[OK] Interaction matrix shape: {interaction_matrix.shape}")
    print(f"[OK] Event similarity matrix shape: {event_similarity.shape}")
    ...
    if len(recommendations) > 0:
        print("[OK] CF is working with real data!")
    else:
        print("[WARNING] CF returned no recommendations")
else:
    print("\n[ERROR] Real data not loaded!")
